...
// e_i 
draw((centre_dot_x+0.45,0) -- (centre_dot_x+0.45,-first_shake_height*shake_height_increase^3+0.3),p=linewidth(0.8pt),bar=Bars(size=3));
label("$\epsilon_l(t)$", (centre_dot_x+1.75,-1.25));
...
//real tunnelling_curve_height = 0.9;
//real tunnelling_curve_space_to_dot_x = 0.4;
//draw((centre_dot_x - 2*dot_separation_x + tunnelling_curve_space_to_dot_x,tunnelling_line_height) .. (centre_dot_x - 1.5*dot_separation_x ,tunnelling_line_height+tunnelling_curve_height) .. (centre_dot_x - dot_separation_x - tunnelling_curve_space_to_dot_x,tunnelling_line_height));
//draw((centre_dot_x - dot_separation_x   + tunnelling_curve_space_to_dot_x,tunnelling_line_height) .. (centre_dot_x - 0.5*dot_separation_x ,tunnelling_line_height+tunnelling_curve_height) ..                     (centre_dot_x- tunnelling_curve_space_to_dot_x,tunnelling_line_height));
//draw((centre_dot_x  + tunnelling_curve_space_to_dot_x                    ,tunnelling_line_height) .. (centre_dot_x + 0.5*dot_separation_x ,tunnelling_line_height+tunnelling_curve_height) .. (centre_dot_x + dot_separation_x - tunnelling_curve_space_to_dot_x,tunnelling_line_height));
//draw((centre_dot_x + dot_separation_x + tunnelling_curve_space_to_dot_x  ,tunnelling_line_height) .. (centre_dot_x + 1.5*dot_separation_x ,tunnelling_line_height+tunnelling_curve_height) .. (centre_dot_x + 2*dot_separation_x - tunnelling_curve_space_to_dot_x,tunnelling_line_height));
//real label_height = 1.9;
//real J0_label_leftshift = 0.1;
//label("$J_0$", (centre_dot_x - 1.5*dot_separation_x - J0_label_leftshift,label_height));
//label("$J_0$", (centre_dot_x - 0.5*dot_separation_x - J0_label_leftshift,label_height));
//label("$J_0$", (centre_dot_x + 0.5*dot_separation_x - J0_label_leftshift,label_height));
//label("$J_0$", (centre_dot_x + 1.5*dot_separation_x - J0_label_leftshift,label_height));
...
label("$A_{l-3}$", (centre_dot_x - 3*dot_separation_x-0.7, -first_shake_height-0.5));
label("$A_{l-2}$", (centre_dot_x - 2*dot_separation_x+0.9, first_shake_height*shake_height_increase+0.5));
label("$A_{l-1}$", (centre_dot_x - dot_separation_x, -first_shake_height*shake_height_increase^2-0.5));
label("$A_{l}$", (centre_dot_x, first_shake_height*shake_height_increase^3+0.5));
label("$A_{l+1}$", (centre_dot_x+ dot_separation_x+0.9, -first_shake_height*shake_height_increase^4-0.5));
label("$A_{l+2}$", (centre_dot_x+2*dot_separation_x+0.3, first_shake_height*shake_height_increase^5+0.5));
label("$A_{l+3}$", (centre_dot_x+3*dot_separation_x+1.4, -first_shake_height*shake_height_increase^4-0.5));
