...
{
    if(i_d %4== 0) {
        draw((i_d*5,0) -- (i_d*5,large_shake_height), p=rgb(colour5)+linewidth(0.9pt), arrow=ArcArrow(SimpleHead, size=4));
        draw((i_d*5,0) -- (i_d*5,-large_shake_height), p=rgb(colour5)+linewidth(0.9pt)+linetype("2 2"), arrow=ArcArrow(SimpleHead, size=4));
    } else if (i_d %4 == 1) {
        draw((i_d*5,0) -- (i_d*5,small_shake_height), p=rgb(colour1)+linewidth(0.9pt), arrow=ArcArrow(SimpleHead, size=4));
        draw((i_d*5,0) -- (i_d*5,-small_shake_height), p=rgb(colour1)+linewidth(0.9pt)+linetype("2 2"), arrow=ArcArrow(SimpleHead, size=4));
     } else if (i_d %4 == 2) {
        draw((i_d*5,0) -- (i_d*5,large_shake_height), p=rgb(colour5)+linewidth(0.9pt)+linetype("2 2"), arrow=ArcArrow(SimpleHead, size=4));
        draw((i_d*5,0) -- (i_d*5,-large_shake_height), p=rgb(colour5)+linewidth(0.9pt), arrow=ArcArrow(SimpleHead, size=4));
     } else if (i_d %4 == 3) {
