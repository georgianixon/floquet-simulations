...
pair c_label_loc = table_start + (fig_label_x,fig_label_y) - (0,table_y_space*4);
pair d_label_loc = c_label_loc - (0,5);
pair e_label_loc = d_label_loc + (14.6,0);

pair c_fig_loc =  table_start - (0,table_y_space*4.5) + (fig_label_x*1.1,0);
pair d_fig_loc = c_fig_loc - (0,3);
pair e_fig_loc = d_fig_loc + (14.6,0);

label("(a)", a_label_loc);
label("(b)",b_label_loc);

label(graphic("/home/gnixon/floquet-simulations/figures/local_mod_paper/grad_mag_field_flux.pdf"),c_fig_loc, right);
label("(c)", c_label_loc);


label(graphic("/home/gnixon/floquet-simulations/figures/local_mod_paper/flux_ladder_flux_vals.pdf"), d_fig_loc, SE);
label(graphic("/home/gnixon/floquet-simulations/figures/local_mod_paper/flux_ladder_abs_vals.pdf"), e_fig_loc, SE);
label("(d)", d_label_loc);
label("(e)", e_label_loc);
