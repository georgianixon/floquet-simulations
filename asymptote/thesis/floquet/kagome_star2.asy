...
string[] inner_labs = {"3", "2", "1", "3", "1", "2"};
string[] outer_labs = {"1", "3", "2", "2", "3", "1"};
string[] tri_phases = {"$-\phi$", "$-\phi$", "$-\phi$", "$\phi$", "$\phi$", "$\phi$"};
pen[] tri_phase_pens = {rgb(pale_orange), rgb(pale_orange), rgb(pale_orange), rgb(pale_blue), rgb(pale_blue), rgb(pale_blue)};
