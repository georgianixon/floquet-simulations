...
// ###################### First Triangle
//shaking arrows
real arrow_height2 = 2.7;
real arrow_height3 = 1.6;

real lattice_space=6.6;

draw((0,0) -- (0,arrow_height2), p=rgb(colour6)+linewidth(2.5pt), arrow=ArcArrow(SimpleHead, size=5));
draw((0,0) -- (0,-arrow_height2), p=rgb(colour6)+linewidth(2.5pt)+linetype("2 2"), arrow=ArcArrow(SimpleHead, size=5));
...
// ######################### Second Triangle
pair triangle_shift = (2.5*lattice_space,0);
//shaking arrows
