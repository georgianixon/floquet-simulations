...
string[] inner_labs = {"1", "2", "1", "2", "1", "3"};
string[] outer_labs = {"3", "3", "3", "3", "2", "2"};
string[] tri_phases = {"$-\phi$", "$-\phi$", "$-\phi$", "$\phi$", "$\phi$", "$\phi$"};
pen[] tri_phase_pens = {rgb(pale_blue), rgb(pale_orange), rgb(pale_blue), rgb(pale_orange), rgb(pale_orange), rgb(pale_blue)};
