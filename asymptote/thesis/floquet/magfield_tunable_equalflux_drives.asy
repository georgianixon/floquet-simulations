...
// draw dots
int i_dot = 0;
string varphi_vals[] =  {"$\frac{5 \pi}{4}$","$\frac{\pi}{4}$","$\frac{\pi}{4}$", "$\frac{5 \pi}{4}$","$\frac{7 \pi}{4}$", "$\frac{7 \pi}{4}$","$\frac{3 \pi}{4}$","$\frac{3 \pi}{4}$", "$\frac{\pi}{4}$","$\frac{5 \pi}{4}$","$\frac{5 \pi}{4}$", "$\frac{\pi}{4}$", "$\frac{3 \pi}{4}$", "$\frac{3 \pi}{4}$","$\frac{7 \pi}{4}$","$\frac{7 \pi}{4}$"};
pair label_gap = 0.9*(1,-1);
real arrow_size = 1.2;
...
{ 
    for (int i_x = 0; i_x < lat_Lx; ++i_x)
    {
        ...
        label(varphi_vals[i_dot], (i_x, i_y)*lat_space + label_gap);
        i_dot = i_dot + 1;
    }
}
