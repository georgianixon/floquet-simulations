...
pair label_shift = (0,1.5);

label(graphic("/home/gnixon/floquet-simulations/asymptote/thesis/floquet/kagome_rhombus_nagaosa.pdf"),a_fig_loc, SE);
label("(a)", a_fig_loc + label_shift, SE);


label(graphic("/home/gnixon/floquet-simulations/asymptote/thesis/floquet/kagome_rhombus_alt.pdf"),b_fig_loc , SE);
