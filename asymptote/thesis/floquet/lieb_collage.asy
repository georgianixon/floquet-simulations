...
label(graphic("/home/gnixon/floquet-simulations/asymptote/thesis/floquet/lieb_lattice1.pdf"),a_fig_loc);
label("(a)", a_label_loc);

// label(graphic("/home/gnixon/floquet-simulations/figures/local_mod_paper/lieb_lattice_shake1.pdf"),b_fig_loc);
label(graphic("/home/gnixon/floquet-simulations/asymptote/thesis/floquet/lieb_lattice2.pdf"),b_fig_loc);
label("(b)", b_label_loc);

// label(graphic("/home/gnixon/floquet-simulations/figures/local_mod_paper/lieb_lattice_shake2.pdf"),c_fig_loc);
label(graphic("/home/gnixon/floquet-simulations/asymptote/thesis/floquet/lieb_lattice4.pdf"),c_fig_loc);
label("(c)", c_label_loc);
