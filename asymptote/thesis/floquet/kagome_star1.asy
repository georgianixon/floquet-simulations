...
string pale_red = "#F0C9DD";
string pale_orange = "#FDDDC3";

string[] inner_labs = {"2", "3", "2", "3", "2", "3"};
string[] outer_labs = {"1", "1", "1", "1", "1", "1"};
string[] tri_phases = {"$\phi$", "$-\phi$", "$\phi$", "$-\phi$", "$\phi$", "$-\phi$"};
pen[] tri_phase_pens = {rgb(pale_blue), rgb(pale_orange), rgb(pale_blue), rgb(pale_orange), rgb(pale_blue), rgb(pale_orange)};
