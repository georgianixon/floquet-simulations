...
pair label_shift = (0.7,-0.9);

label(graphic("/home/gnixon/floquet-simulations/figures/thesis/black_hole/HSt0_linear_gradient_sz6.pdf"),a_fig_loc, SE);
label("(a)", a_fig_loc + label_shift);


label(graphic("/home/gnixon/floquet-simulations/figures/thesis/black_hole/HSt0_linear_gradient_tunnelling_terms_sz6.pdf"),b_fig_loc +(0,b_fig_yshift), SE);
label("(b)", b_fig_loc + label_shift + (0.5,0));
