    ...
    for omega0 in omega0s:
        ...
        for phi2_frac in phi2s:
            ...
            for phi3_rel_frac in phi3Rels:
                ...
                J23_real = -(1/T)*integrate.quad(lambda t: cos(A3/omega3*sin(omega3*t + phi2 + phi3_rel) - A2/omega2*sin(omega2*t + phi2)), -T/2, T/2)[0]
                J23_imag = -1j*(1/T)*integrate.quad(lambda t: sin(A3/omega3*sin(omega3*t + phi2 + phi3_rel) - A2/omega2*sin(omega2*t + phi2)), -T/2, T/2)[0]
                        # we are removing esimate of absolute error
                J23 = J23_real + J23_imag
                        
                J31_real = -(1/T)*integrate.quad(lambda t: cos(-A3/omega3*sin(omega3*t + phi2 + phi3_rel)), -T/2, T/2)[0]
                J31_imag = -1j*(1/T)*integrate.quad(lambda t: sin(-A3/omega3*sin(omega3*t + phi2 + phi3_rel)), -T/2, T/2)[0]
                J31 = J31_real + J31_imag
                    
                # J12 = -jv(0,A2/omega2)
                  
                J12_real = -(1/T)*integrate.quad(lambda t: cos(A2/omega2*sin(omega2*t + phi2)), -T/2, T/2)[0]
                J12_imag = -1j*(1/T)*integrate.quad(lambda t: sin(A2/omega2*sin(omega3*t + phi2)), -T/2, T/2)[0]
                J12 = J31_real + J31_imag
