...
if __name__ == "__main__":
    ...
    # omega0s = np.linspace(4,20,16+1)
    
    
    # phi3s = np.linspace(0, 1, 41, endpoint=False)
    ...
    for omega0_add in omega0_additions:
        omega0 = np.round(omega0_base + omega0_add,2)
